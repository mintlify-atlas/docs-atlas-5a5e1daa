...
For the complete color palette, see the [Color Palette Reference](/guides/color-palette).
...
- Explore the [Color Palette](/guides/color-palette) for all available theme colors